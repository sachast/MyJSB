...
class FicheRepository extends EntityRepository{ 
	...
	public function rechercherFiche($recherche_motCle){   //Si uniquement titre (menu gauche)
		return $this->getEntityManager()->createQuery(
		"SELECT f FROM IdentiteFicheBundle:Fiche f WHERE f.titre LIKE '%$recherche_motCle%'"
		)->getResult();
	}
